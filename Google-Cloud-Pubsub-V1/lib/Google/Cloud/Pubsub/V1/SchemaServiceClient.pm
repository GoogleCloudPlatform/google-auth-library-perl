package Google::Cloud::Pubsub::V1::SchemaServiceClient;
...
1; # End of Google::Cloud::Pubsub::V1::SchemaServiceClient

__END__

=head1 NAME

Google::Cloud::Pubsub::V1::SchemaServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Pubsub::V1::SchemaServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Pubsub::V1::SchemaServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Pubsub::V1::SchemaServiceClient> is an auto-generated client library for Google Cloud Services.
