package Google::Cloud::Sql::V1::SqlFlagsServiceClient;
...
1; # End of Google::Cloud::Sql::V1::SqlFlagsServiceClient

__END__

=head1 NAME

Google::Cloud::Sql::V1::SqlFlagsServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Sql::V1::SqlFlagsServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Sql::V1::SqlFlagsServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Sql::V1::SqlFlagsServiceClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Sql::V1::SqlFlagsServiceClient->new(
