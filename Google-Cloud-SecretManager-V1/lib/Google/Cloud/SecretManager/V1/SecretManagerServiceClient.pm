...
Google::Cloud::SecretManager::V1::SecretManagerServiceClient - Auto-generated client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $client = Google::Cloud::SecretManager::V1::SecretManagerServiceClient->new( credentials => $auth );
