package Google::Cloud::Compute::V1::RegionSslCertificatesClient;
...
1; # End of Google::Cloud::Compute::V1::RegionSslCertificatesClient

__END__

=head1 NAME

Google::Cloud::Compute::V1::RegionSslCertificatesClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Compute::V1::RegionSslCertificatesClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Compute::V1::RegionSslCertificatesClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Compute::V1::RegionSslCertificatesClient> is an auto-generated client library for Google Cloud Services.
