package Google::Cloud::Compute::V1::MachineTypesClient;
...
1; # End of Google::Cloud::Compute::V1::MachineTypesClient

__END__

=head1 NAME

Google::Cloud::Compute::V1::MachineTypesClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Compute::V1::MachineTypesClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Compute::V1::MachineTypesClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Compute::V1::MachineTypesClient> is an auto-generated client library for Google Cloud Services.
