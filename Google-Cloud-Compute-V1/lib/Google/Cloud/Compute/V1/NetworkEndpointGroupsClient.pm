package Google::Cloud::Compute::V1::NetworkEndpointGroupsClient;
...
1; # End of Google::Cloud::Compute::V1::NetworkEndpointGroupsClient

__END__

=head1 NAME

Google::Cloud::Compute::V1::NetworkEndpointGroupsClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Compute::V1::NetworkEndpointGroupsClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Compute::V1::NetworkEndpointGroupsClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Compute::V1::NetworkEndpointGroupsClient> is an auto-generated client library for Google Cloud Services.
...
=head2 new
    ...
    my $client = Google::Cloud::Compute::V1::NetworkEndpointGroupsClient->new(
