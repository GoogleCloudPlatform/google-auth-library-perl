package Google::Cloud::Compute::V1::PublicAdvertisedPrefixesClient;
...
1; # End of Google::Cloud::Compute::V1::PublicAdvertisedPrefixesClient

__END__

=head1 NAME

Google::Cloud::Compute::V1::PublicAdvertisedPrefixesClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Compute::V1::PublicAdvertisedPrefixesClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Compute::V1::PublicAdvertisedPrefixesClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Compute::V1::PublicAdvertisedPrefixesClient> is an auto-generated client library for Google Cloud Services.
