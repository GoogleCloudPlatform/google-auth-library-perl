package Google::Cloud::Bigquery::V2::ProjectServiceClient;
...
1; # End of Google::Cloud::Bigquery::V2::ProjectServiceClient

__END__

=head1 NAME

Google::Cloud::Bigquery::V2::ProjectServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Bigquery::V2::ProjectServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Bigquery::V2::ProjectServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Bigquery::V2::ProjectServiceClient> is an auto-generated client library for Google Cloud Services.
