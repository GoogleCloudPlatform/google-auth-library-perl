...
Google::Cloud::Bigquery::V2::ModelClient - Auto-generated client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $client = Google::Cloud::Bigquery::V2::ModelClient->new( credentials => $auth );
