package Google::Cloud::Bigquery::V2::TableServiceClient;
...
1; # End of Google::Cloud::Bigquery::V2::TableServiceClient

__END__

=head1 NAME

Google::Cloud::Bigquery::V2::TableServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Bigquery::V2::TableServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Bigquery::V2::TableServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Bigquery::V2::TableServiceClient> is an auto-generated client library for Google Cloud Services.
