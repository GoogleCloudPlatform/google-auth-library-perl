...
BEGIN {
    for my $pkg (qw( Google::Cloud::Networkservices::V1::Dep::ListLbTrafficExtensionsResponse Google::Cloud::Networkservices::V1::EndpointPolicy::ListEndpointPoliciesResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
