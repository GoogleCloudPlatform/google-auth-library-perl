...
BEGIN {
    for my $pkg (qw( Google::Cloud::Networksecurity::V1::SseRealm::ListSACRealmsResponse )) {
        unless ($pkg->can('new')) {
            no strict 'refs';
...
my $client = Google::Cloud::NetworkSecurity::V1::SSERealmServiceClient->new( credentials => 'dummy' );
