package Google::Cloud::Dataplex::V1::DataScanServiceClient;
...
1; # End of Google::Cloud::Dataplex::V1::DataScanServiceClient

__END__

=head1 NAME

Google::Cloud::Dataplex::V1::DataScanServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Dataplex::V1::DataScanServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Dataplex::V1::DataScanServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Dataplex::V1::DataScanServiceClient> is an auto-generated client library for Google Cloud Services.
