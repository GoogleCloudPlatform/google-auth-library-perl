...
Google::Cloud::Dataplex::V1::DataplexServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Dataplex::V1::DataplexServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Dataplex::V1::DataplexServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
