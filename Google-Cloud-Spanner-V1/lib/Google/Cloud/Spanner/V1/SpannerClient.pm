...
Google::Cloud::Spanner::V1::SpannerClient - Auto-generated client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $client = Google::Cloud::Spanner::V1::SpannerClient->new( credentials => $auth );
