package Google::Cloud::SQL::V1::SqlOperationsServiceClient;
...
1; # End of Google::Cloud::SQL::V1::SqlOperationsServiceClient

__END__

=head1 NAME

Google::Cloud::SQL::V1::SqlOperationsServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::SQL::V1::SqlOperationsServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::SQL::V1::SqlOperationsServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::SQL::V1::SqlOperationsServiceClient> is an auto-generated client library for Google Cloud Services.
