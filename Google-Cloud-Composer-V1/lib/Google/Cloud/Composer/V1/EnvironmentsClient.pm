...
Google::Cloud::Composer::V1::EnvironmentsClient - Auto-generated client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $client = Google::Cloud::Composer::V1::EnvironmentsClient->new( credentials => $auth );
