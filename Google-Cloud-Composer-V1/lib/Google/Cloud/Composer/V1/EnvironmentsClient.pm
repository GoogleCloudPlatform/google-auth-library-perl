package Google::Cloud::Composer::V1::EnvironmentsClient;
...
Google::Cloud::Composer::V1::EnvironmentsClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Composer::V1::EnvironmentsClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Composer::V1::EnvironmentsClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Composer::V1::EnvironmentsClient> is an auto-generated client library for Google Cloud Services.
