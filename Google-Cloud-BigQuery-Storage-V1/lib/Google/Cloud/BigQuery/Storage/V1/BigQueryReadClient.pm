...
Google::Cloud::BigQuery::Storage::V1::BigQueryReadClient - Auto-generated client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $client = Google::Cloud::BigQuery::Storage::V1::BigQueryReadClient->new( credentials => $auth );
