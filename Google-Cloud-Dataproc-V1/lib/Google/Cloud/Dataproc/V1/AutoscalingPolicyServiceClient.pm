package Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient;
...
1; # End of Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient

__END__

=head1 NAME

Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Dataproc::V1::AutoscalingPolicyServiceClient> is an auto-generated client library for Google Cloud Services.
