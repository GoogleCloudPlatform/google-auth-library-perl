package Google::Cloud::Dataflow::V1Beta3::FlexTemplatesServiceClient;
...
1; # End of Google::Cloud::Dataflow::V1Beta3::FlexTemplatesServiceClient

__END__

=head1 NAME

Google::Cloud::Dataflow::V1Beta3::FlexTemplatesServiceClient - Client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $grpc_client = Google::Cloud::Dataflow::V1Beta3::FlexTemplatesServiceClient->new(
        credentials => $auth,
        transport   => 'grpc', # Optional: 'grpc' is default
    );

    # 2. HTTP/REST Transport
    my $rest_client = Google::Cloud::Dataflow::V1Beta3::FlexTemplatesServiceClient->new(
        credentials => $auth,
        transport   => 'rest',
    );
...
C<Google::Cloud::Dataflow::V1Beta3::FlexTemplatesServiceClient> is an auto-generated client library for Google Cloud Services.
