...
Google::Cloud::Dataflow::V1Beta3::JobsV1Beta3Client - Auto-generated client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $client = Google::Cloud::Dataflow::V1Beta3::JobsV1Beta3Client->new( credentials => $auth );
