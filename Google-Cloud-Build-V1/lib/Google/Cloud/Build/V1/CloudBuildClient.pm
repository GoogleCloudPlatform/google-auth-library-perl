...
Google::Cloud::Build::V1::CloudBuildClient - Auto-generated client library for Google Cloud Services
...
=head1 SYNOPSIS
    ...
    my $client = Google::Cloud::Build::V1::CloudBuildClient->new( credentials => $auth );
